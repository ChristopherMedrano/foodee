<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<c:forEach var="log" items="${breakfastLog}">
		<!-- Edit Foodlog Link -->
	...
	<c:set var="dailyCalories" value="${caloriesTotal}" scope="request"/>
	<c:set var="dailyCarbs" value="${carbsTotal}" scope="request"/>
	<c:set var="dailyFats" value="${fatsTotal}" scope="request"/>
	<c:set var="dailyProtein" value="${proteinTotal}" scope="request"/>
